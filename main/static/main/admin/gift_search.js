...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const category = document.getElementById("hidden-categ").value;
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    setTimeout(()=>{
                        ...
                        if (category == 'admin') {
                            window.location.href = "/admin_customer_list/";  // redirect from js
                        } else {
                            window.location.href = "/employers_customer_list/";  // redirect from js
                        }
